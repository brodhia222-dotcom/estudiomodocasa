...
/**
 * Campo de partículas tipo "sparkles" — adaptado de Aceternity (21st.dev).
 *
 * Usa tsparticles para renderizar partículas que parpadean con animación
 * de opacidad. Para ModoCasa lo dejamos en B&N: fondo transparente (la
 * sección padre define el fondo ink), partículas blancas con opacidad
 * variable. La densidad y velocidad por defecto son moderadas para que
 * el efecto sea elegante, no ruidoso.
 */
          ...
          options={{
            ...
            interactivity: {
              events: {
                ...
                resize: true as unknown as undefined,
              },
              modes: {
                push: {
                  quantity: 4,
